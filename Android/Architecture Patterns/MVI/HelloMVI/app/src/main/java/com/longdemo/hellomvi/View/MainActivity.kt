package com.longdemo.hellomvi.View
...
import com.longdemo.hellomvi.R
import com.longdemo.hellomvi.Utils.DataSource
import com.longdemo.hellomvi.View.Presenter.MainPresenter
...
class MainActivity : MviActivity<MainView, MainPresenter>(), MainView {
    ...
    override var imageIntent: Observable<Int>
        get() = RxView.clicks(btn_get_data)
            .map { getRandomNumberInRange(0, imageList.size - 1) }
        set(value) {}
    ...
    override fun render(viewState: MainViewState) {
        if (viewState.isLoading)
        {
            ...
            Toast.makeText(this@MainActivity, "" + viewState.error?.message.toString(), Toast.LENGTH_LONG).show()
        }
